...
import com.puntoclick.data.database.userstoreassignment.daofacade.UserStoreAssignmentDaoFacadeImp
...
val daoFacadeModule = module {
    ...
    singleOf(::UserStoreAssignmentDaoFacadeImp){
        bind<UserStoreAssignmentDaoFacade>()
    }
}